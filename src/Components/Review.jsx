    ...
    <section className="container mx-auto mb-8 mt-12" id="review">
        ...
        className="flex flex-col ">
            ...
            className="flex items-center justify-center gap-6">
                <img src={xaviour} alt={REVIEW.name} width={80} height={80}
        ...
        md:flex-row">
            {[customer1 , customer2, customer3 ,customer4].map((customer,index)=> (
                <motion.img variants={itemVariants} key={index} src={customer} alt="customer"
                className="h-[300px] w-[300px] rounded-br-3xl rounded-tl-3xl 
